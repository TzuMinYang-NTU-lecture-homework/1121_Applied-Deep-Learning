...
def get_prompt(instruction: str) -> str:
    ...
    # return f"Please make a sentence to describe the personality of the reader who likes to read '{instruction}' types of books without using below words: {instruction}. ANSWER:"
